...
class YovaPipeline(AudioPipeline):
    def __init__(self, logger):
        ...
        self.add_processor(AGCProcessor(logger, sample_rate=16000, target_level_dbfs=-18.0, max_gain_db=20.0, min_gain_db=-20.0, attack_time_ms=5.0, release_time_ms=50.0, ratio=4.0))  # Add AGC
